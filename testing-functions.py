# 1) Write a 'split_name' function that takes a string 
# and returns a dictionary with first_name and last_name
...
# 2) Ensure that 'split_name' can handle multi-name last names
...
# 3) Write an 'is_palindrome' function to check if a string is a 
...
# 4) Make 'is_palindrom' work with numbers
